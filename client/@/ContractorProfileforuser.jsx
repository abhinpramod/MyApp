...
// Confirmation Dialog Component (Reused from owner view)
...
const DynamicProfile = () => {
  ...
  const { contractorId2 } = useParams();
  // const currentUser = useSelector((state) => state.user);
  const currentContractor= useSelector((state) => state.contractor);
  console.log("currentContractor", currentContractor.contractor);
  const contractorId= currentContractor?.contractor._id 
...
useEffect(() => {
  if (currentContractor) {
    setIsOwner(currentContractor?.contractor._id === contractorId);
  } else {
    setIsOwner(false);
  }
  ...
  useEffect(() => {
    ...
    fetchContractorData();
  }, [contractorId , isOwner, navigate]);

  // Common handlers from both components
  ...
  const handleSubmitInterest = async (e) => {
    ...
    try {
      setIsLoading(true);
      await axiosInstance.post(`/user/contractor/interest/${contractorId}`, {
        formData,
        contractor
      });
  ...
  return (
    <>
      ...
      {/* <Navbar /> */}
      <div className="p-6 max-h-fit min-h-screen max-w-4xl mx-auto shadow-lg rounded-2xl mt-12">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex flex-col items-center w-full md:w-1/3">
            <div className="relative">
              ...
              />
              {/* Profile picture upload for owner */}
              {isOwner && (
                <label
            ...
            {/* Description Section - Editable for owner */}
            <div className="w-full mt-2">
              {isOwner && isEditingDescription ? (
                ...
                <div 
                  onClick={isOwner ? handleEditDescription : undefined}
                ...
                >
                  <p className={`text-center ${
                    ...
                    {contractor.description || 
                      (isOwner ? "Click here to add a description..." : "No description provided")}
                  </p>
                </div>
              )}
            </div>
          ...
          <div className="w-full md:w-2/3 space-y-4">
            ...
            {/* Number of Employees - Editable for owner */}
            <div className="flex items-center gap-2">
              <strong>Number of Employees:</strong>
              {isOwner && isEditingEmployees ? (
                <div className="flex items-center gap-2">
                  <TextField
                    type="number"
