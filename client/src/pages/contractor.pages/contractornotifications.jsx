    ...
    <div className="p-6 mt-5 bg-white rounded-2xl shadow-lg border border-gray-200 transition-transform transform hover:scale-105 hover:shadow-xl">
      ...
      <div className="space-y-2">
        <p className="text-gray-700">
          <span className="font-semibold">Address:</span> {interest.address}
        </p>
        <p className="text-gray-700">
        ...
        <p className="text-gray-700">
          <span className="font-semibold">Job Type:</span> {interest.jobTypes}
        </p>
        <p className="text-gray-700">
        ...
        <p className="text-gray-700">
          <span className="font-semibold">Email:</span> {interest.email}
        </p>
      </div>
      <button
