            ...
            {isSmallScreen ? (
              ...
              <Grid container spacing={2}>
                {interestHistory.length === 0 ? (
                  <Grid item xs={12} className="text-center py-8 text-gray-500">
                    ...
                    <Grid item xs={12} key={interest._id}>
                      <Card className="p-4">
                        ...
                        <Typography variant="body2" className="text-gray-600">
                          Email: {interest.contractorEmail}
                        </Typography>
                        <Typography variant="body2" className="text-gray-600">
                          Address: {truncateText(interest.address, 30)}
                        </Typography>
                        <Typography variant="body2" className="text-gray-600">
                          Job Types: {truncateText(interest.jobTypes.join(", "), 30)}
                        </Typography>
                        <Typography variant="body2" className="text-gray-600">
                          Expected Date: {interest.expectedDate}
                        </Typography>
                ...
                <Table>
                  <TableHead>
                    <TableRow className="bg-blue-200">
                      <TableCell className="font-bold text-blue-300">
                        Company Name
                      </TableCell>
                      <TableCell className="font-bold text-blue-300">
                        Email
                      ...
                      <TableCell className="font-bold text-blue-300 text-center">
                        Status
                      </TableCell>
                    </TableRow>
                  </TableHead>
